...
class HttpTasksTest extends HttpTaskServerTestMain {
    ...
    void testAddTask() throws IOException, InterruptedException {
        ...
        assertEquals("Test Task", tasks[0].getTitle(), "Некорректное имя задачи");
    }
    ...
    void testGetTaskById() throws IOException, InterruptedException {
        ...
        assertEquals("Test Task", responseTask.getTitle(), "Неверное имя задачи");
    }
