...
class HttpTaskEpicsTest extends HttpTaskServerTestMain {

    @Test
    void testAddEpic() throws IOException, InterruptedException {
        Epic epic = new Epic(0, "Test Epic", "Test Description"); // id = 0
        String epicJson = gson.toJson(epic);

        HttpResponse<String> response = createEpic(epicJson);
        ...
        assertEquals("Test Epic", epics[0].getTitle(), "Некорректное имя эпика");
    }
